...
# from FuCadUp and writes version.nsh file in the directory the script is located at
# (the Python module keeps its upstream name for macro and addon compatibility)
import FreeCAD
import datetime
import os
